...
public class PaymentSteps {
    ...
    @And("user make deposit via {string} {string} {string}")
    public void userMakeDepositVia(String phone, String name, String amount) {
        actor.attemptsTo(Payment.type(phone, name, amount));
    }
